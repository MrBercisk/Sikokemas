    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                    <form method="POST" action="<?= base_url('Data_dokter/update_data_dokter') ?>" enctype="multipart/form-data">
                    <div class="mb-3 row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Nama Dokter</label>
                            <div class="col-sm-10">
                                <input type="text" name="nama_dokter" value="<?=$a['nama_dokter'];?>" >
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="hidden" name="hidden_foto" value="<?=$a['foto'];?>">
                            </div>
                        </div>

                        <input type="hidden" name="id_dokter" value="<?=$a['id_dokter'];?>">
