    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                ?>
                    <form method="POST" action="<?= base_url('Data_puskesmas/update_data_puskesmas') ?>" enctype="multipart/form-data">
                    <div class="mb-3 row">
                            <label for="staticEmail" class="col-sm-2 col-form-label">Nama Puskesmas</label>
                            <div class="col-sm-10">
                                <input type="text" name="nama_puskesmas" value="<?=$a['nama_puskesmas'];?>" >
                            </div>
                        </div>
                        <div class="mb-3 row">
                        ...
                        <input type="hidden" name="id_puskesmas" value="<?=$a['id_puskesmas'];?>">
